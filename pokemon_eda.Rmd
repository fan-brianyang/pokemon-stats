...
p_load(httr, jsonlite, rvest, 
       xml2, readr, here, diffdf,
       tidyr, ggplot2, dplyr, tibble)

WD <- getwd()
.pokepath <- "/Data_Projects/pokedata/pokemon.csv"
pokedata <- read_csv(paste0(WD, .pokepath))
```
