...
-   Less important, but I made *.pdex* a variable by itself in case I have to rerun the wrangling code to make any quick adjustments. This way, I won't get an error since the wrangled data gets written into a new variable.
...
gen6Mega <- c("Venasaur", "Charizard", "Blastoise", "Alakazam", )
gen7Mega <- c("",)
